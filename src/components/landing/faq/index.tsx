  ...
  const faqData = [
    {
      ...
      answer:
        "A 24-hour hackathon for dedicated builders and innovators. It's one part party, one part work-hard overnight battle against the clock and the competition. ",
    },
    {
      question: "When and where is SANKALP2025?",
      answer: "September 20-21, 2025. Venue: MVGR College of Engineering - CSE Department",
    },
    {
      question: "Who can participate?",
      answer:
        "Students currently enrolled in any course in College can participate in SANKALP2025",
    },
    {
      question: "How do I register?",
      answer: (
        <span>
          Registration opens from 1st September 2025 to 7th September 2025 on Google Forms.
          Follow our social media for announcements.
          <br />
          <a
            href={
              "https://forms.gle/FiBkTbkz63U89HDWA"
            }
    ...
    },
    {
      ...
      answer:
        "Yes! Technical mentors available throughout.",
    },
    {
      ...
      answer: (
        <span>
          ...
          <b>Round 1 – Online Submission via GoogleForm :</b> Submit a PPT of a past
          project for screening.
          <br />
          <span role="img" aria-label="school">
            🏫
          </span>{" "}
          <b>Round 2 – Offline Hackathon at MVGR College of Engineering:</b> If selected, your
          ...
          <b>
            Only teams selected for Round 2 must pay a one-time registration fee of ₹299 per member (to be paid as a single payment for the entire team,
             e.g., a team of 4 members will pay 4 × 299 = ₹1196).
          </b>{" "}
          Meals and stay are covered. Just bring your laptop{" "}, chargers{" "}
      ...
      answer: (
        <span>
          ...
          <ul className="list-disc ml-6">
            ...
            <li>If you don't have a previous experience - briefly describe your idea or concept.</li>
          </ul>
          <br />
    ...
    },
    {
      ...
      answer: (
        <span>
          ...
          <b>Round 2 (Offline):</b> ₹299 per member (to be paid as a single payment for the entire team, e.g., a team of 4 members will pay 4 × 299 = ₹1196).
        </span>
      ),
    },
    {
      ...
      answer: (
        <span>
          Your team will be invited to the offline hackathon from 20 to 21
          September 2025 at MVGR College of Engineering - CSE Department. It’s a
          24-hour on-campus event where you'll build a brand new project from
          scratch based on surprise problem statements revealed at the venue. To
          confirm your spot, you’ll need to pay the registration fee per team
          after selection.
        </span>
      ),
    },
    ...
    },
    {
      ...
      answer:
        "Registration is free. However, if you are selected, you will need to pay for final confirmation.",
    },
    {
        question: "Are there any perks or swags?",
        answer: "Yes! The first 100 registered students will have an exclusive chance to receive the swag.",
      },
    ...
    },
    {
      ...
      answer:
        "Yes, meal(i.e., dinner ) and breakfast and basic accommodation will be arranged for all offline participants.",
    },
      ...
      <div className="max-w-6xl mx-auto mt-14">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#ccc] max-w-3xl mx-auto px-2">
            Everything you need to know about SANKLAP 2025. Can't find what
