...
const TextReveal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    animeTextContainersRef.current.forEach((container, index) => {
      ...
      const scrollMultiplier = 0.5; // Even faster animation for all devices
  ...
  className="about anime-text-container bg-[#141414] text-black relative w-full h-full min-h-[90vh] lg:min-h-[100vh] p-3 sm:p-4 md:p-6 lg:p-8 overflow-x-hidden"
      >
        ...
        >
          <div className="w-full h-full mx-auto flex flex-col justify-center items-center text-center rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-xl bg-[#f9ffa5] p-4 sm:p-6 md:p-8 lg:mt-30 lg:mb-30">
