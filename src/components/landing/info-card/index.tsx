  ...
  const rounds = [
    {
      ...
      subtitle: "Preliminary Screening Round",
      description:
        "Qualify by submitting a presentation of a past project. We'll evaluate your team's technical skills. Briefly include: Team Intro & Project Overview, Tech Stack Used, Screenshots or Live Links(if available). And if you don't have any previous projects, feel free to showcase your ideas! *For screening only. Cannot be used in the finale.*",
      icon: "💻", // Computer emoji for digital round
      bgColor: "#f9ffa5", // Bright green background for first round
    },
    {
      title: "24-Hours Offline Finale",
      subtitle: "At MVGR College of Engineering - CSE Department",
      description:
        "The selected teams are invited to the CSE department for the finale. You'll have 24 hours to build a new project from scratch based on surprise problem statements revealed at the event. Let the coding begin!",
      icon: "🏆", // Trophy emoji for physical location
      ...
      >
        ...
        <div className="w-full h-full flex flex-col justify-start md:justify-center items-center pt-12 md:pt-0 p-3 sm:p-4 md:p-6 lg:p-8 relative">
          {/* ============================================================================
              ...
              ============================================================================ */}
          <h1 className="w-full text-center max-w-[95%] sm:max-w-[90%] md:max-w-[85%] lg:max-w-[80%] xl:max-w-[75%] 2xl:max-w-[75%] text-[#fcf2e8] text-5xl sm:text-5xl md:text-2xl lg:text-6xl xl:text-7xl 2xl:text-7xl font-black leading-relaxed sm:leading-tight md:leading-tight lg:leading-tight px-2 sm:px-4 z-10 mb-4 sm:mb-6 md:mb-8">
            How It Works
          </h1>
          ...
          <div className="max-w-4xl z-5 mb-4 sm:mb-6 md:mb-8">
            <p className="text-[#ccc] text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-relaxed rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-3xl border border-dashed border-[rgb(60,60,60)] p-4 sm:p-6 md:p-8 lg:p-10 mt-10">
              ...
              have what it takes to be a Sankalp champion.
            </p>
          </div>
